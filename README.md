...
DeepFly3D **does not require a calibration pattern**, it enforces **geometric constraints using pictorial structure**, which corrects most of the erros, and the **remaining errors are automatically detected can be dealt with easily with GUI assistance**.
